...
<https://zenn.dev/asterisk9101/articles/fedora44server-1>
...
```bash
nmcli con mod 'Wired connection 1' ipv4.dns 192.168.1.24
...
DNS1=192.168.1.24
DNS2=192.168.1.28
nmcli con mod 'Wired connection 1' ipv4.dns $DNS1,$DNS2
systemctl restart NetworkManager
```
